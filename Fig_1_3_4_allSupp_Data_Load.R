...
# there are 3 individuals who were apparently included in the refractory group but who never received IV abx and went straight from oral abx to prolonged NSAID course (notably NOT a DMARD). These were very early patients so the clinical algorithm / treatment pathway was not yet established and that's why they didn't get IV abx and DMARD. They PROBABLY should be in the refractory group but not totally clear they wouldnt have responded to IV abx. These patients were thus excluded.
